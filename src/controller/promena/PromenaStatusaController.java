...
public class PromenaStatusaController {
    ...
    public static List<IzvodjenjeDto> ucitaj() {

        Connection connection = Config.getConnection();
        int istrazivacId = Session.getIstrazivacId();

        String query =
                "SELECT DISTINCT izv.izvodjenje_id, " +
        ...
        try {
            ...
            while (rs.next()) {
                ...
                IzvodjenjeDto dto = new IzvodjenjeDto(
                        ...
                        rs.getString("status"),
                        rs.getObject("rezultat") == null
                                ? null
                                : rs.getDouble("rezultat"),
                        rs.getObject("merna_nesigurnost") == null
                                ? null
                                : rs.getDouble("merna_nesigurnost")
                );
